                        ...
                        <div class="navbar">
                            <div class="user-details mr-auto">
                                ...
                                <div class="user-info float-left">
                                    <a href="profile.php"><span class="font-bold">Jennifer Robinson</span> <i
                            ...
                            <ul class="nav custom-menu">
                                <li class="nav-item">
                                    <a href="#chat_sidebar" class="nav-link task-chat profile-rightbar float-right"
                                        ...
                                        <div class="chat chat-left">
                                            <div class="chat-avatar">
                                                <a href="profile.php" class="avatar">
                                                    <img alt="Jennifer Robinson" src="assets/img/patient-thumb-02.jpg"
                                                ...
                                                <div class="chat-bubble">
                                                    <div class="chat-content">
                                                        ...
                                                        <ul class="attach-list">
                                                            <li><i class="fa fa-file"></i> <a href="#">example.avi</a>
                                                            </li>
                                                            <li><i class="fa fa-file"></i> <a href="#">activity.psd</a>
                                                            </li>
                                                            <li><i class="fa fa-file"></i> <a href="#">example.psd</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                ...
                                <div class="chat-box">
                                    <div class="chats">
                                        <div class="chat chat-left">
                                            <div class="chat-avatar">
                                                <a href="profile.php" class="avatar">
                                                    <img alt="Cristina Groves" src="assets/img/doctor-thumb-03.jpg"
                                                        class="img-fluid rounded-circle">
                                                </a>
                                            </div>
                                            <div class="chat-body">
                                                <div class="chat-bubble">
                                                    <div class="chat-content">
                                                        <span class="chat-user">You</span> <span class="chat-time">8:35
                                                            am</span>
                                                        <div class="call-details">
                                                            <i class="material-icons">phone_missed</i>
                                                            <div class="call-info">
                                                                <div class="call-user-details">
                                                                    <span class="call-description">Jeffrey Warden missed
                                                                        the call</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="call-info">
                                                                <div class="call-user-details">
                                                                    <a href="#"
                                                                        ...
                                                                        data-qa="call_attachment_link">Calling Jennifer
                                                                        ...</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="chat-profile-info">
                                                <ul class="user-det-list">
                                                    ...
                                                    <li>
                                                        <span>Email:</span>
                                                        <span
                                                            class="float-right text-muted">cristinagroves@example.com</span>
                                                    </li>
                                                    <li>
                                                        <span>Phone:</span>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <label>Send invi'tes to <span class="text-muted-light">(optional)</span></label>
                            <input class="form-control" type="text">
                        </div>
