            ...
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        ...
                        <li class="menu-title">Chat Groups <a href="#" class="add-user-icon" data-toggle="modal"
                        ...
                        <li>
                            <a href="chat.php"><span class="chat-avatar-sm user-img"><img src="assets/img/user.jpg"
                                        alt="" class="rounded-circle"><span class="status online"></span></span> John
                                Doe <span class="badge badge-pill bg-danger float-right">1</span></a>
                        </li>
                        <li>
                            <a href="chat.php"><span class="chat-avatar-sm user-img"><img src="assets/img/user.jpg"
                                        alt="" class="rounded-circle"><span class="status offline"></span></span>
                                Richard Miles <span class="badge badge-pill bg-danger float-right">18</span></a>
                        </li>
                        <li>
                            <a href="chat.php"><span class="chat-avatar-sm user-img"><img src="assets/img/user.jpg"
                                        alt="" class="rounded-circle"><span class="status away"></span></span> John
                                Smith</a>
                        </li>
                        <li class="active">
                            <a href="chat.php"><span class="chat-avatar-sm user-img"><img src="assets/img/user.jpg"
                                        alt="" class="rounded-circle"><span class="status online"></span></span> Mike
                                Litorus <span class="badge badge-pill bg-danger float-right">108</span></a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="navbar">
                                    <div class="user-details mr-auto">
                                        <div class="float-left user-img m-r-10">
                                            <a href="profile.php" title="Mike Litorus"><img src="assets/img/user.jpg"
                                                    alt="" class="w-40 rounded-circle"><span
                                                    class="status online"></span></a>
                                        </div>
                                        <div class="user-info float-left">
                                            <a href="profile.php" title="Mike Litorus"><span class="font-bold">Mike
                                                    Litorus</span></a>
                                    ...
                                    <ul class="nav custom-menu">
                                        <li class="nav-item">
                                            <a class="task-chat profile-rightbar float-right" href="#chat_sidebar"
                                                id="task_chat"><i aria-hidden="true" class="fa fa-comments"></i></a>
                                        </li>
                                                    ...
                                                    <div class="chat-body">
                                                        <div class="chat-bubble">
                                                            <div class="chat-content">
                                                                <span class="chat-user">You</span> <span
                                                                ...
                                                                <div class="chat-body">
                                                                    <div class="chat-bubble">
                                                                        <div class="chat-content">
                                                                            ...
                                                                            <span class="chat-time">Dec 17, 2014 at
                                                                                4:32am</span>
                                            ...
                                            <div class="table-body">
                                                <div class="table-content">
                                                    <div class="chat-profile-img">
                                                        ...
                                                        <a href="edit-profile.php" class="btn btn-primary edit-btn"><i
