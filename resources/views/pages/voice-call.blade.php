                    ...
                    <ul>
                        ...
                        <li class="active">
                            <a href="chat.php"><span class="chat-avatar-sm user-img"><img src="assets/img/user.jpg"
                                ...
                                Jennifer <span class="badge badge-pill bg-danger float-right">108</span></a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="navbar">
                                    <div class="user-details mr-auto">
                                        <div class="float-left user-img m-r-10">
                                            <a href="profile.php" title="Jennifer Robinson"><img
                                                    src="assets/img/user.jpg" alt="" class="w-40 rounded-circle"><span
                                                    class="status online"></span></a>
                                        </div>
                                        <div class="user-info float-left">
                                            <a href="profile.php" title="Jennifer Robinson"><span
                                                    class="font-bold">Jennifer Robinson</span></a>
